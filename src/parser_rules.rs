...
impl Parser {
    ...
    pub(crate) fn rules(&mut self) -> HashMap<TokenType, ParseRule> {
        ...
        h.insert(TokenBang, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        h.insert(TokenBangEqual, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        h.insert(TokenEqual, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        h.insert(TokenEqualEqual, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        h.insert(TokenGreater, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        h.insert(TokenGreaterEqual, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        h.insert(TokenLess, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        h.insert(TokenLessEqual, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        ...
        h.insert(TokenFalse, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        ...
        h.insert(TokenNil, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
        ...
        h.insert(TokenTrue, ParseRule { prefix: None, infix: None, precedence: ParsePrecedence::PrecedenceNone });
